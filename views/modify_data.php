...
<body>
    ...
    <div class="tab-content">  
        <div class="tab-pane active container-fluid" id="users"  ng-app='usersAppli' ng-controller="usersControleur">  
        ...
        <div class="tab-pane" id="exp_pro"  ng-app="expProAppli" ng-controller="expProControleur">
            <form method="post" action="../controllers/verification_creation_ctrl.php">
        ...
        <div class="tab-pane " id="trainings"  ng-app="trainAppli" ng-controller="trainControleur">
            <form method="post" action="../controllers/verification_creation_ctrl.php">      
                <div class="row" ng-repeat="trainings in trainings">
                    ...
                    <div class="form-group col-8 offset-2">
                        ...
                        <input id="texte" type="text" class="form-control" name="dipl_validate_train" value={{trainings.dipl_validate_train}}>
                    </div> 
                    <!-- Force next columns to break to new line -->
                    <div class="w-100"></div>
                    <div class="offset-2 col-1">
        ...
        <div class="tab-pane" id="skills"  ng-app="skillsAppli" ng-controller="skillsControleur">
            <form method="post" action="../controllers/verification_creation_ctrl.php">
        ...
        <div class="tab-pane" id="realisations"  ng-app="realisationsAppli" ng-controller="realisationsControleur">
            <form method="post" action="../controllers/verification_creation_ctrl.php">
        ...
        <div class="tab-pane" id="activities"  ng-app="activitiesAppli" ng-controller="activitiesControleur">
            <form method="post" action="../controllers/verification_creation_ctrl.php">
