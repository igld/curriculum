<?php session_start(); echo "<br>"; // $id_users = $_SESSION['id_users'];  ?>
<!doctype html>
<html lang="fr">
  <head>
  ...
  <!-- Retour vers la partie modification -->
  <body>
  <button onclick="location.href='add_modify_delete_data.php'">Retour</button>
  <!-- Non urtilisé pour le moment pas efficace  -->
  <!-- <body><button id="cmd">PDF</button> -->
    ...
    <div id="main-container" class="container-fluid">						
            ...
            <p ng-repeat="trainings in trainings">
              <table>
                <tr>
                  ...
                  <td><strong>{{trainings.dipl_name_train}}</strong><br>{{trainings.school_train}} à {{trainings.location_train}}<br>{{trainings.title_train}} ({{trainings.dipl_validate_train}})</td>
                </tr>
              </table>
            </p>
          </div> 
      ...
      /* Non utilisé pour le moment pas des plus fonctionnel
      var doc = new jsPDF();
      ...
      $('#cmd').click(function () {   
          doc.fromHTML($('#main-container').html(), 2.5, 2.5, {
              'width': 170,
